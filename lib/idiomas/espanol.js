...
//_allantilink.js
const smsTextoYT = () => { return ' 𝗦𝘂𝗽𝗲𝗿 𝑩𝑶𝑻-𝑪.𝑫.𝑹 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const eGataCoins = () => { return '💵 dinero' }
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar BOT-C.D.R`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar BOT-C.D.R en Grupos`}
...
const smsContacto4 = () => { return 'Contacto Oficial de BOT-C.D.R 🥷🏻'}
